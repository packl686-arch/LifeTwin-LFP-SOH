...
<body>
  <header class="topbar">
    <div class="brand"><strong>LifeTwin</strong><span>评审证据控制台</span></div>
    <div class="mode-badge">回顾性证据回放 · 非实时推理</div>
  </header>
  ...
  <main class="shell">
    ...
    <footer class="auditline">
      ...
      <div class="provenance"><span id="source-count"></span> 个冻结证据文件<br><code id="source-sha"></code></div>
    </footer>
  </main>
