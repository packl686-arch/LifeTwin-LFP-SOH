"""Deterministic bootstrap and capability-minimal CLI for V2.4."""
...
_BOOTSTRAP_MARKER = "LIFETWIN_V024_DETERMINISTIC_BOOTSTRAP"
_THREAD_VARIABLES = (
    "OMP_NUM_THREADS",
...
_ATTEMPT_ID = "v024-formal-20260810-a1"
sys.path.insert(0, str(_PROJECT_ROOT / "src"))


def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Execute the one-shot frozen V2.4 lifecycle.",
    )
    parser.add_argument(
        "--internal-stage",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.internal_stage == "generation":
        ...
        from lifetwin.experiments.calendar_long_horizon_v019_runner import (  # noqa: PLC0415
    ...
    if args.internal_stage == "prediction":
        ...
        from lifetwin.experiments.calendar_long_horizon_v019_prediction import (  # noqa: PLC0415
