"""Deterministic capability-minimal CLI for the fixed V2.8 profile."""
...
_BOOTSTRAP_MARKER = "LIFETWIN_V028_DETERMINISTIC_BOOTSTRAP"
_THREAD_VARIABLES = (
    "OMP_NUM_THREADS",
...
_ATTEMPT_ID = "v028-formal-20260814-a1"
sys.path.insert(0, str(_PROJECT_ROOT / "src"))


def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Execute the one-shot frozen V2.8 lifecycle.",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.internal_stage == "generation":
        ...
        from lifetwin.experiments.calendar_long_horizon_v023_runner import (  # noqa: PLC0415
    ...
    result = run_formal_attempt_v028(
        attempt_id=attempt_id,
        label_free_root=args.label_free_root,
        sealed_truth_root=args.sealed_truth_root,
