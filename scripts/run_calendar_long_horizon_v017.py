"""Deterministic bootstrap and capability-minimal CLI for V2.2."""
...
_BOOTSTRAP_MARKER = "LIFETWIN_V022_DETERMINISTIC_BOOTSTRAP"
_THREAD_VARIABLES = (
    "OMP_NUM_THREADS",
...
_ATTEMPT_ID = "v022-formal-20260809-a1"
sys.path.insert(0, str(_PROJECT_ROOT / "src"))


def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Execute the one-shot frozen V2.2 lifecycle.",
    )
    parser.add_argument(
        "--internal-stage",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.internal_stage == "generation":
        ...
        from lifetwin.experiments.calendar_long_horizon_v017_runner import (  # noqa: PLC0415
    ...
    if args.internal_stage == "prediction":
        ...
        from lifetwin.experiments.calendar_long_horizon_v017_prediction import (  # noqa: PLC0415
