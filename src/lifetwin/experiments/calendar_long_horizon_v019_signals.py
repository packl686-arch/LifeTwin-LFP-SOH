"""Lightweight nominal exception signals shared by V2.4 stages.
...
class V024CalibrationTerminalInconclusive(RuntimeError):
...
__all__ = ["V024CalibrationTerminalInconclusive"]
