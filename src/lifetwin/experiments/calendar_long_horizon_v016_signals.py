"""Lightweight nominal exception signals shared by V2.1 stages.
...
class V021CalibrationTerminalInconclusive(RuntimeError):
...
__all__ = ["V021CalibrationTerminalInconclusive"]
