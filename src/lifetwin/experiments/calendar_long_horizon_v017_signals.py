"""Lightweight nominal exception signals shared by V2.2 stages.
...
class V022CalibrationTerminalInconclusive(RuntimeError):
...
__all__ = ["V022CalibrationTerminalInconclusive"]
